...
var mapElementPointHelper = {
    elementId: -1,
    getElementsLocationsActionUrl: "",
    createElementPointActionUrl: "",
    getElementPointActionUrl: "",
    getElementPointAttributesActionUrl: "",
    getElementsAttributesActionUrl: "",
    elementPointWorkFlowViewSingleActionUrl: "",
    updateElementPointAttributesActionUrl: "",
    indexPath: "",

    /**
    * Ajax request to get element locations.
    */
    getElementLocations: function(handleData) {
        // Create final path.
    ...
    * @param {any} long
    */
    createElementPoint: function(lat, long) {
        // Build final path.
    ...
    */
    createAndShowAttributeForm: function(elementPointData, elementPointAttributesData) {
        // Log data.
    ...
    * @param {elementPointObject} elementPointData
    */
    getElementPointAttributes: function(elementPointId, elementPointData) {
        // Create final path.
        ...
        return $.ajax({
            ...
            complete: function(response) {
                ...
                // Create form.
                mapElementPointHelper.createAndShowAttributeForm(elementPointData, data);
            }
        });
    },
    ...
    */
    getElementPoint: function(elementPointId) {
        // Build final path.
        ...
        return $.ajax({
            ...
            complete: function(response) {
                ...
                mapElementPointHelper.getElementPointAttributes(elementPointId, data);
            }
        });
    },
