...
var MapsOracle = function() {
    ...
    var showMap = function() {
        ...
        mapElementPointHelper.elementId = -1;
        var canAddOracleElement = false;

        var baseUrl = "http://192.168.88.15:8080/mapviewer";
        ...
        $('.add-markers').click(
            function (event) {
                ...
                mapElementPointHelper.elementId = event.target.id.split("-")[1];

                // Request element locations and create markers in map.
                mapElementPointHelper.getElementLocations(function(points) {
                    addFoi(points);
                });

                // Update global element attributes to use in create attribute for after click on the markers.
                mapElementPointHelper.getElementAttributes();
            });
        ...
        function mouseClick() {
            ...
            mapElementPointHelper.createElementPoint(mouseLoc.getPointX(), mouseLoc.getPointY());
        }
        ...
        */
        ...
        function addFoi(elementLocationsDto) {
            ...
            for (var i = 0; i < count; i++) {
                ...
                var iFoi = MVFOI.createMarkerFOI(generateRandomUnique(),
                    iPoint,
                    getMaprkerIcon(elementLocationsDto.ElementPoints[i].CurrentState),
                    10,
                    10);;
                ...
                iFoi.attachEventListener(MVEvent.MOUSE_CLICK,
                    function(evt, mvfoi) {
                        ...
                        mapElementPointHelper.getElementPoint(mvfoi.infoTip);
                    });
